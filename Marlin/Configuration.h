...
#define EXTRUDER_OFFSET_X {0.0, 19.90} // (in mm) per extruder, offset of the extruder on the X axis
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.1600, 80.1600, 2260.0000, 757.2200, 757.2200} // X,Y,Z,E0... SAE Prusa w/ Wade extruder
